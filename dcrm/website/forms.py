...
class SignUpForm(UserCreationForm):
    ...
    # Here we are basically doing the same thing that we did for the signup form but for username, password1,
    # and password2.
...
# class Meta seems like the meta data for this form like which model does it use and other
    # attributes
    class Meta:
        model = Record
        # He says this will add all of the fields
        exclude = ("user",)
